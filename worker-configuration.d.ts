/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1072853219af547eb0778026a99f315b)
...
interface __BaseEnv_Env {
	...
	QUESTIONS: DurableObjectNamespace<import("./worker/index").QuestionBank>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Room" | "QuestionBank";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANSWER_SECONDS" | "REVEAL_MS" | "SCORES_MS" | "LOBBY_MIN_PLAYERS" | "MAX_PLAYERS" | "DEFAULT_ROUNDS" | "ADMIN_TOKEN">> {}
}
